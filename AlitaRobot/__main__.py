...
from AlitaRobot.modules import ALL_MODULES
from AlitaRobot.modules.helper_funcs.chat_status import is_user_admin
from AlitaRobot.modules.helper_funcs.misc import paginate_modules
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="ℹ️ ABOUT", callback_data="Alita_"),
...
ALITA_IMG = "https://telegra.ph/file/754a36d8c2e2b01f2a3a9.png"
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("AlitaRobot.modules." + module_name)
    ...
    if query.data == "Alita_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Alita*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \nHere is the [💾Repository](https://github.com/TeamEviral/AlitaRobot).
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Back", callback_data="Alita_back")
                 ]
                ]
            ),
        )
    elif query.data == "Alita_back":
        query.message.edit_text(
                PM_START_TEXT,
                reply_markup=InlineKeyboardMarkup(buttons),
                parse_mode=ParseMode.MARKDOWN,
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *Alita*
                 \nHere is the [Source Code](https://github.com/TeamEviral/AlitaRobot) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Yes I am on 😹")
        except Unauthorized:
            LOGGER.warning(
