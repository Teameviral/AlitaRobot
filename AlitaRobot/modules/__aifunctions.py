...
from AlitaRobot import telethn, OWNER_ID
from AlitaRobot.events import register
from AlitaRobot import events
from telethon import types
from telethon.tl import functions
import asyncio, os

@register(pattern="Alita (.*)")
async def hmm(event):
  ...
  if "no no" in result:
   pro = "I am fairly yound and I was made by @Eviral."
   try:
