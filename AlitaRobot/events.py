...
from AlitaRobot import MONGO_DB_URI
from AlitaRobot import telethn
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import AlitaRobot.events

        path = Path(f"AlitaRobot/modules/{shortname}.py")
        name = "AlitaRobot.modules.{}".format(shortname)
        ...
        mod.alitarobot = alitarobot
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["AlitaRobot.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "AlitaRobot/modules/*.py"
